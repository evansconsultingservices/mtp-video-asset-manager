  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background/50 backdrop-blur-sm shadow-sm text-foreground hover:bg-accent/80 hover:text-accent-foreground hover:shadow-md",
        secondary:
        ...
        ghost: "text-foreground hover:bg-accent/80 hover:text-accent-foreground backdrop-blur-sm hover:shadow-sm",
